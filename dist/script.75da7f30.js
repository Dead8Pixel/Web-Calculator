...
var calcString = "";
var ans = 0;
var previousOp = undefined;
var display = document.querySelector('.display');
var calcButton = document.querySelector('#calculator');
...
calcButton.addEventListener('click', function (event) {
  if (event.target.tagName == 'BUTTON') {
    var doCalculations = function doCalculations(ans, val, op) {
      var res = 0;
    ...
    if (event.target.className.includes('num')) {
      ...
      if (display.innerText == '0') display.innerText = value;else display.innerText += value;
    } //Clear Button logic
